...
def upgrade() -> None:
    values = [
        ...
        (
            "('00000000-0000-0000-0000-000000000002', 'PLTR', 'NASDAQ', "
            "'Palantir Technologies Inc.', 'ai')"
        ),
        (
            "('00000000-0000-0000-0000-000000000003', 'LMT', 'NYSE', "
            "'Lockheed Martin Corporation', 'defence')"
        ),
        ("('00000000-0000-0000-0000-000000000004', 'RTX', 'NYSE', 'RTX Corporation', 'defence')"),
        (
            "('00000000-0000-0000-0000-000000000005', 'SMR', 'NYSE', "
            "'NuScale Power Corporation', 'nuclear')"
        ),
        (
            "('00000000-0000-0000-0000-000000000006', 'CCJ', 'NYSE', "
            "'Cameco Corporation', 'nuclear')"
        ),
        (
            "('00000000-0000-0000-0000-000000000007', 'ENPH', 'NASDAQ', "
            "'Enphase Energy, Inc.', 'green_energy')"
        ),
        (
            "('00000000-0000-0000-0000-000000000008', 'FSLR', 'NASDAQ', "
            "'First Solar, Inc.', 'green_energy')"
        ),
        ("('00000000-0000-0000-0000-000000000009', 'IONQ', 'NYSE', 'IonQ, Inc.', 'quantum')"),
        (
            "('00000000-0000-0000-0000-00000000000a', 'RGTI', 'NASDAQ', "
            "'Rigetti Computing, Inc.', 'quantum')"
        ),
        ...
        (
            "('00000000-0000-0000-0000-00000000000d', 'RKLB', 'NASDAQ', "
            "'Rocket Lab USA, Inc.', 'space')"
        ),
